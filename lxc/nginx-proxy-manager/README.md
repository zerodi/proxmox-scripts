...
```bash
curl -sL https://raw.githubusercontent.com/zerodi/proxmox-scripts/main/lxc/nginx-proxy-manager/create.sh | bash -s
```
...
```bash
curl -sL https://raw.githubusercontent.com/zerodi/proxmox-scripts/main/lxc/nginx-proxy-manager/create.sh | bash -s -- --cores 4
```
...
```bash
wget --no-cache -qO - https://raw.githubusercontent.com/zerodi/proxmox-scripts/main/lxc/nginx-proxy-manager/setup.sh | sh
```
